...
\begin{homeworkProblem}
	\begin{enumerate}
		...
		\item Consider the following game: I write down a nuber (1,2, or 3)
...
\begin{homeworkProblem}
	...
	boxes, one opaque and one trasparent. The transparent box has \$1000 in it for sure.
	...
	is simply to maximize his monetary gain. P's strange preferences are to demostrate his
	correct predicion in the following way: Only put money in the box if he thinks
	C will select one box; otherwise, do not put money in the box (ignore mixed strategies for this problem).
	If P predixts correctly, his payoff is 10; otherwise it is 0. Here is the game in matrix form:

	\begin{enumerate}
		\item Explain why this is a static game of complete information.
		\item Fin dhte uniwue surviving set of stategies using IESD.
		...
		\item If you read ahead to chapter 7 and 8, we will discuss dynamic games of complete information.
		      Solve the dynamic games you described in part (c) using Subgame Perfect Nash Equilibrium.
	\end{enumerate}
\end{homeworkProblem}
